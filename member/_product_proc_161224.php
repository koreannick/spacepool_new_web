...
if(file_exists($save_path_tmp.$bimg))					copy($save_path_tmp.$bimg,$save_path.$bimg);
	...
	$result = mysql_query("select bimg,img1,img2,img3,id from es_product where uid=$uid");
	if($result&&mysql_num_rows($result)>0){
